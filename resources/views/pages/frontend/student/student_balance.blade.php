        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body refered_stutednt">
                    ...
                    <div class="mb-3">
                        <label>Amount</label>
                        <input type="number" class="form-control s_withraw_amount">
                        <input type="hidden" class="form-control s_withraw_student_id">
                    </div>
                    <div class="mb-3">
                        <select class="form-control s_withraw_method">
                    ...
                    <div class="mb-3">
                        <label>Number</label>
                        <input type="number" class="form-control s_withraw_number">
                    </div>
                    <div class="mb-3">
                        <label>Password</label>
                        <input type="password" class="form-control s_withraw_password">
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-success s_withraw_btn">Withraw</button>
                </div>
            </div>
        </div>
    </form>
